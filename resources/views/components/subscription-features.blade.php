...
<ul class="{{ $sp }}">
    ...
    <li class="{{ $s }}">
        ...
        <div style="margin-left:32px;" class="mt-1.5 flex items-center gap-3">
            ...
            <svg style="width:27px;height:27px;" class="flex-shrink-0" viewBox="0 0 87.3 78"><path d="M6.6 66.85 3.3 61.35 29.1 17.1h26.5z" fill="#0066DA"/><path d="M29.1 17.1l26.5 0 28.8 49.75H57.3z" fill="#00AC47"/><path d="M31.2 66.85l-24.6 0L29.1 17.1l26.5 0z" fill="#0066DA"/><path d="M84.4 66.85H31.2L55.6 17.1h0z" fill="#00AC47"/><path d="M6.6 66.85H31.2L29.2 78z" fill="#2684FC"/><path d="M31.2 66.85l53.2 0L58.2 78H29.2z" fill="#FFBA00"/></svg>
            ...
            <svg style="width:27px;height:27px;" class="flex-shrink-0" viewBox="0 0 43.35 40.4"><path d="M12.87 0L0 8.1l8.8 7.06 12.87-8.4zM0 22.22l12.87 8.1 8.8-7.06-12.87-8.4zM21.67 23.26l8.8 7.06 12.88-8.1-8.81-7.06zM43.35 8.1L30.47 0l-8.8 7.06 12.87 8.1zM21.72 25.16l-8.85 6.98-4.02-2.63v2.95l12.87 7.73 12.87-7.73v-2.95l-4.02 2.63z" fill="#0061FF"/></svg>
            <svg style="width:27px;height:27px;" class="flex-shrink-0" viewBox="0 0 36 36"><rect width="36" height="36" rx="8" fill="#6D4AFF"/><path d="M9 10h14.5L18 18l5.5 8H9l5.5-8z" fill="white"/></svg>
        </div>
        @endif
    </li>

...
<ul class="{{ $sp }}">
    ...
    @else
    <li class="flex items-center gap-3 {{ $s }}">
        <i class="fa-solid fa-people-group {{ $ico }} w-5 text-center {{ $icoOff }}"></i>

    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 transform bg-batid-marine text-white transition-transform lg:relative lg:translate-x-0"
            ...
            <nav class="mt-4 space-y-1 px-3">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.subscription-types.*', 'admin.orders.*', 'admin.promo-codes.*', 'admin.user-groups.*', 'admin.payments.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" class="ml-6 space-y-1">
                        ...
                        <a href="{{ route('admin.payments.index') }}" class="block rounded px-3 py-2 text-[14px] text-white/60 hover:text-white">Paiements</a>
                    </div>
                </div>
                <div x-data="{ open: {{ request()->routeIs('admin.admins.*', 'admin.settings.*', 'admin.languages.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="flex w-full items-center justify-between rounded-lg px-3 py-2.5 text-[15px] text-white/80 transition hover:bg-white/10">
                    ...
                    <div x-show="open" class="ml-6 space-y-1">
                        ...
                        <a href="{{ route('admin.languages.index') }}" class="block rounded px-3 py-2 text-[14px] text-white/60 hover:text-white">Langues</a>
                    </div>
                </div>
                @endif
